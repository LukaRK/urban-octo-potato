...
namespace traco_opname
{
    public partial class Form_main : Form
    {
        ...
        List<Grippervariant> m_grippervariantlist = new List<Grippervariant>();
        ...
        private void Verwerk()
        {
            ...
            for (int i = 0; i < m_zijdes.Count; ++i)
            {
                ...
                //{
                    ...
                    //if (i == 0) { waarde = z1safedistmax; }
                    //if (i == 1) { waarde = z2safedistmax; }
                    //if (i == 2) { waarde = z3safedistmax; }
                    //if (i == 3) { waarde = z4safedistmax; }
            ...
            for (int g = 0; g < m_grippervariantlist.Count; ++g)
            {
                ...
                {
                    foreach (Kpoint k in m_grippervariantlist[g].OpnameZoneZijde1)
                    {//kopieren zone1 in de oplossing
                        m_grippervariantlist[g].OpnameZoneZijde12.Add(k);
                    }
                    //pas zone12 aan rekening houdende met recht1 van zone2
                    for (int i = 0; i < m_rechtelistzijde2.Count; ++i) //voor elke rechte van zone2
                    {
                        int i1 = i +1;
                        if (i1 == m_rechtelistzijde2.Count)
                        {
                            ...
                            Rechte r = m_rechtelistzijde2[i1];//WAAROM i3 ipv i
                            ...
                            int snijindex1=0;
                            int snijindex2=0;
                            for (int j = 0; j < m_grippervariantlist[g].OpnameZoneZijde12.Count; ++j) //voor elke rechte van zone2
                            {//snijpunt met elke zone berekenen maar enkel die overhouden die binnen de ljnstukken liggen
                                int i2 = j;
                                int i3 = i2 + 1;
                                if (i3 == m_grippervariantlist[g].OpnameZoneZijde12.Count) { i3 = 0; }

                                
                                if (!samenvallend(r, new Rechte(m_grippervariantlist[g].OpnameZoneZijde12[i2], m_grippervariantlist[g].OpnameZoneZijde12[i3])))
                                {
                                    Kpoint p1 = snijpunt(r, new Rechte(m_grippervariantlist[g].OpnameZoneZijde12[i2], m_grippervariantlist[g].OpnameZoneZijde12[i3]));
                                    if (((p1.X <= m_grippervariantlist[g].OpnameZoneZijde12[i2].X && p1.X >= m_grippervariantlist[g].OpnameZoneZijde12[i3].X) || (p1.X >= m_grippervariantlist[g].OpnameZoneZijde12[i2].X && p1.X <= m_grippervariantlist[g].OpnameZoneZijde12[i3].X))
                                    && ((p1.Y <= m_grippervariantlist[g].OpnameZoneZijde12[i2].Y && p1.Y >= m_grippervariantlist[g].OpnameZoneZijde12[i3].Y) || (p1.Y >= m_grippervariantlist[g].OpnameZoneZijde12[i2].Y && p1.Y <= m_grippervariantlist[g].OpnameZoneZijde12[i3].Y))
                                    )
                                    {
                            ...
                            {// enkel die afkappingen doen waarbij een van de twee snijpunten ligt tussen begi n en eind punt van zone 2 linstuk liggen
                                ...
                                if ((((snijpunt1.X <= m_grippervariantlist[g].OpnameZoneZijde2[i].X && snijpunt1.X >= m_grippervariantlist[g].OpnameZoneZijde2[i1].X) || (snijpunt1.X >= m_grippervariantlist[g].OpnameZoneZijde2[i].X && snijpunt1.X <= m_grippervariantlist[g].OpnameZoneZijde2[i1].X))
                                         && ((snijpunt1.Y <= m_grippervariantlist[g].OpnameZoneZijde2[i].Y && snijpunt1.Y >= m_grippervariantlist[g].OpnameZoneZijde2[i1].Y) || (snijpunt1.Y >= m_grippervariantlist[g].OpnameZoneZijde2[i].Y && snijpunt1.Y <= m_grippervariantlist[g].OpnameZoneZijde2[i1].Y)))
                                    || (((snijpunt2.X <= m_grippervariantlist[g].OpnameZoneZijde2[i].X && snijpunt2.X >= m_grippervariantlist[g].OpnameZoneZijde2[i1].X) || (snijpunt2.X >= m_grippervariantlist[g].OpnameZoneZijde2[i].X && snijpunt2.X <= m_grippervariantlist[g].OpnameZoneZijde2[i1].X))
                                         && ((snijpunt2.Y <= m_grippervariantlist[g].OpnameZoneZijde2[i].Y && snijpunt2.Y >= m_grippervariantlist[g].OpnameZoneZijde2[i1].Y) || (snijpunt2.Y >= m_grippervariantlist[g].OpnameZoneZijde2[i].Y && snijpunt2.Y <= m_grippervariantlist[g].OpnameZoneZijde2[i1].Y))))
                                {// snijpunt 1  of 2 ligt er binnen opnamezone 2, dus afsnijden

                                    //Zone12 verkleinen aan de hand van die 2 snijpunten
                                    for (int j = 0; j < m_grippervariantlist[g].OpnameZoneZijde12.Count; ++j) 
                                     {
                                        Kpoint p1=new Kpoint(m_grippervariantlist[g].OpnameZoneZijde12[j].X, m_grippervariantlist[g].OpnameZoneZijde12[j].Y,0);
                                         bool bp1 = false;
                                        ...
                                        {
                                            result12.Add(p1);
                                            if (j == snijindex1 && !(snijpunt1.X == p1.X && snijpunt1.Y == p1.Y)) result12.Add(snijpunt1);//
                                            if (j == snijindex2 && !(snijpunt2.X == p1.X && snijpunt2.Y == p1.Y)) result12.Add(snijpunt2);//
                                        }
                                        else{
                                            if (j==snijindex1) result12.Add(snijpunt1);
                                            if (j==snijindex2) result12.Add(snijpunt2);
                            ...
                            samenvallendepunte(ref result12);
                    //    kopieer result12 in opnamezijde12 en kijk naar volgende rechte


                    }

                        if (m_grippervariantlist[g].OpnameZoneZijde12.Count > 0) { m_grippervariantlist[g].OplossingZijde12 = true; }
                    }
                #endregion
                    #region z3
                    allesgechecked = false;
                    ...
                    {
                        minx = m_grippervariantlist[g].OpnameZone[0].X;
                        miny = m_grippervariantlist[g].OpnameZone[0].Y;
                        maxx = m_grippervariantlist[g].OpnameZone[0].X;
                        maxy = m_grippervariantlist[g].OpnameZone[0].Y;
                        foreach (Kpoint k in m_grippervariantlist[g].OpnameZone)
                        {
                            if (k._X < minx) { minx = k._X; }
                            if (k._X > maxx) { maxx = k._X; }
                            if (k._Y < minx) { miny = k._Y; }
                    ...
                    {
                        minx = m_grippervariantlist[g].OpnameZoneZijde12[0].X;
                        miny = m_grippervariantlist[g].OpnameZoneZijde12[0].Y;
                        maxx = m_grippervariantlist[g].OpnameZoneZijde12[0].X;
                        maxy = m_grippervariantlist[g].OpnameZoneZijde12[0].Y;
                        foreach (Kpoint k in m_grippervariantlist[g].OpnameZoneZijde12)
                        {
                            if (k._X < minx) { minx = k._X; }
                            if (k._X > maxx) { maxx = k._X; }
                            if (k._Y < minx) { miny = k._Y; }
